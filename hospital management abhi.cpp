...
{	
	...
	switch (id)
	{
		case 1:
		{
			cout<<"NAME - DR. N RAJENDRA DESAI"<<endl;
			cout<<"SEX - MALE"<<endl;
		...
		case 2:
		{
			cout<<"NAME - DR. INAYATH KALIL"<<endl;
			cout<<"SEX - MALE"<<endl;
...
cout<<"\t\t\t\t\t\t|_________________________________________________________________|\n\n";
	...
	{
		case 1:
		cout<<"DR. M RAJENDRA DESAI\n TIME :- 10 am TO 1 pm "<<endl;
		break;
		case 2:
		cout<<"DR. INAYATH KALIL\n TIME :- 10 am TO 1 pm "<<endl;
		break;
		case 3:
		cout<<"DR. RAMIKA SEN\n TIME :- 10 am TO 1 pm "<<endl;
		break;
